...
def summary(root:str|Path,config:KdaCudaCampaignConfig,attempt_id=None,ledger=None)->dict[str,Any]:
    ...
    try:
        ...
        return {"schema_version":2,"objective":"naive_to_optimized_project_owned_cuda_kda","quality_not_evaluated":True,"ledger":ready["ledger"],"protocol_sha":ready["protocol_sha"],"anchors_calibrated":calibrated,"current_milestone":head,"next_lane":lane,"attempts":attempts,"next_model_instruction":instruction}
    finally: db.close()
