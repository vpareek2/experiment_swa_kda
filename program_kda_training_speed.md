...
is the pushed annotated tag `kda-speed-prime-context-baseline-20260807`. The pushed
...
git worktree add -b kda-speed/attempt-002 ../kda-speed-attempt-002 \
  kda-speed-prime-context-baseline-20260807
```
...
or copy it into candidate code. The parent may expose the pinned NVIDIA skills reference and the local
`ref/nvidia-docs/AGENT_INDEX.md` reading index with only relevant files to a
